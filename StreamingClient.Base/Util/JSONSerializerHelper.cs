...
namespace StreamingClient.Base.Util
{
    ...
    public static class JSONSerializerHelper
    {
        ...
        public static string SerializeToString<T>(T data, bool includeObjectType = true, IgnorePropertiesResolver propertiesToIgnore = null) => JsonConvert.SerializeObject(data,
        ...
        public static T Clone<T>(object data) => DeserializeFromString<T>(SerializeToString(data));
    ...
    public class IgnorePropertiesResolver : DefaultContractResolver
    {
        ...
        public IgnorePropertiesResolver(IEnumerable<string> propNamesToIgnore) => ignoreProps = new HashSet<string>(propNamesToIgnore);
