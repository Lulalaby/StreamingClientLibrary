namespace Twitch.Base.Models.Clients.Chat
{
	...
	public class ChatUserNoticePacketModel : ChatUserPacketModelBase
	{
		...
		public ChatUserNoticePacketModel(ChatRawPacketModel packet)
			: base(packet)
		{
			UserID = packet.GetTagLong("user-id");
			Login = packet.GetTagString("login");
			DisplayName = packet.GetTagString("display-name");
			Moderator = packet.GetTagBool("mod");
			MessageID = packet.GetTagString("id");
			MessageTypeID = packet.GetTagString("msg-id");
			SystemMessage = packet.GetTagString("system-msg");
			RoomID = packet.GetTagString("room-id");
			Emotes = packet.GetTagString("emotes");
			SubCumulativeMonths = packet.GetTagInt("msg-param-cumulative-months");
			SubPlan = packet.GetTagString("msg-param-sub-plan");
			SubPlanDisplayName = packet.GetTagString("msg-param-sub-plan-name");
			SubShareStreakMonths = packet.GetTagBool("msg-param-should-share-streak");
			SubStreakMonths = packet.GetTagInt("msg-param-streak-months");
			SubGiftSenderLogin = packet.GetTagString("msg-param-sender-login");
			SubGiftSenderDisplayName = packet.GetTagString("msg-param-sender-name");
			SubGiftMonths = packet.GetTagInt("msg-param-months");
			SubGiftRecipientID = packet.GetTagString("msg-param-recipient-id");
			SubGiftRecipientLogin = packet.GetTagString("msg-param-recipient-user-name");
			SubGiftRecipientDisplayName = packet.GetTagString("msg-param-recipient-display-name");
			SubTotalGifted = packet.GetTagInt("msg-param-mass-gift-count");
			SubTotalGiftedLifetime = packet.GetTagInt("msg-param-sender-count");
			SubPromoName = packet.GetTagString("msg-param-promo-name");
			SubPromoTotalGifts = packet.GetTagInt("msg-param-promo-gift-total");
			RaidUserLogin = packet.GetTagString("msg-param-login");
			RaidUserDisplayName = packet.GetTagString("msg-param-displayName");
			RaidViewerCount = packet.GetTagInt("msg-param-viewerCount");
			RitualName = packet.GetTagString("msg-param-ritual-name");
			BitsTierThreshold = packet.GetTagLong("msg-param-threshold");
			SubBenefitEndMonth = packet.GetTagInt("msg-param-sub-benefit-end-month");
			CelebrationEffect = packet.GetTagString("msg-param-effect");
			CelebrationIntensity = packet.GetTagString("msg-param-intensity");
			PriorGifterDisplayName = packet.GetTagString("msg-param-prior-gifter-display-name");
			PriorGifterUserName = packet.GetTagString("msg-param-prior-gifter-user-name");
			Timestamp = packet.GetTagLong("tmi-sent-ts");
		}
	}
}
