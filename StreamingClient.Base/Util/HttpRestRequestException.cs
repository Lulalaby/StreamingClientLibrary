...
namespace StreamingClient.Base.Util
{
    ...
    public class HttpRestRequestException : HttpRequestException
    {
        ...
        public HttpRestRequestException(HttpResponseMessage response)
            : this(response.ReasonPhrase) => Response = response;

        /// <summary>
        /// Returns a string representation of the object.
        /// </summary>
        /// <returns>A string representation of the object</returns>
        public override string ToString() => $"{Response.RequestMessage.RequestUri} - {Response.StatusCode} - {Response.ReasonPhrase} - {Response.GetCallLength()}" + Environment.NewLine +
                Response.Content.ReadAsStringAsync().Result + Environment.NewLine + base.ToString();
    }
}
