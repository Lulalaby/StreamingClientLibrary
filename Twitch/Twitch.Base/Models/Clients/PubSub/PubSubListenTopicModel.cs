...
namespace Twitch.Base.Models.Clients.PubSub
{
	...
	public class PubSubListenTopicModel
	{
        ...
        public PubSubListenTopicModel(PubSubTopicsEnum type) => Type = type;
        ...
        public override string ToString() => (!string.IsNullOrEmpty(Identifier)) ? string.Format("{0}.{1}", EnumHelper.GetEnumName(Type), Identifier) : EnumHelper.GetEnumName(Type);
    }
}
